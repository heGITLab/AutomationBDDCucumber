...
//    public void typeUNandPW(DataTable credential) throws Throwable {
...
//    public void enterPunchIn(DataTable punchIn) throws InterruptedException {
...
//
//        List<List<String>> data = punchIn.asLists();
//
//        dateEl.clear();
//        dateEl.sendKeys(data.get(0).get(0));
//        timeEl.clear();
//        timeEl.sendKeys(data.get(0).get(1));
//        noteEl.clear();
//        noteEl.sendKeys(data.get(0).get(2));
//        driver.findElement(By.id("btnPunch")).click();
//        Thread.sleep(2000);
//    }
//
//    @And("^Enter punch out details$")
//    public void enterPunchOut(DataTable punchOut) throws InterruptedException {
//        WebElement dateEl = driver.findElement(By.id("attendance_date"));
//        WebElement timeEl = driver.findElement(By.id("attendance_time"));
//        WebElement noteEl = driver.findElement(By.id("attendance_note"));
//
//        List<List<String>> data = punchOut.asLists();
//
//        dateEl.clear();
//        dateEl.sendKeys(data.get(0).get(0));
//        timeEl.clear();
